...
# with open("label_encoder_roberta.pkl", "rb") as f:
...
# Load datasets
df_train = pd.read_csv("gpt_500.csv")
...
print("Model saved as 'roberta_email_classifier.pt'")
...
plt.legend()
plt.savefig("roberta_loss_curve.png")
...
plt.legend()
plt.savefig("roberta_accuracy_curve.png")
