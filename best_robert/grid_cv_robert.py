...
class GridSearchWrapper:
    ...
    def run_grid_search(self):
        ...
        final_model = RobertaEmailClassifier(
            num_labels=self.num_classes,
        ...
        # Save best model
        torch.save(final_model.state_dict(), "roberta_email_classifier_best.pt")
        
        # Save best parameters
        with open("roberta_best_params.pkl", "wb") as f:
...
if __name__ == "__main__":
    ...
    print("Best model saved to 'roberta_email_classifier_best.pt'")